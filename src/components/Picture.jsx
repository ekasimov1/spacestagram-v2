...
import { Card, CardMedia, CardContent, IconButton, CardActions, Stack } from "@mui/material";
...
const Picture = (props) => {
    ...
    const strDay = moment(props.selectedDay).format("YYYY-MM-DD");
        const baseUrl = "https://api.nasa.gov/planetary/apod?api_key=YI2hDKwxKEcKWVwcHmrD9lLnnWC3UWHSqUmUcAs9&date=" + strDay;
    ...
    <Card sx={{ maxWidth: 500}, {boxShadow: 3}}>
        ...
        />
            ...
            <CardActions sx={{paddingLeft: 0}}>
                <IconButton aria-label="like" onClick={colorChange} sx={ color === true ? {color: red[500]} : null }>
                <FavoriteIcon />
                </IconButton>    
            </CardActions>
            </CardContent>
